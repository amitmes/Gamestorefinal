...
namespace Gamestorefinal.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(GamestorefinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Adress_name,Cor_x,Cor_y")] Locations locations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adress_name,Cor_x,Cor_y")] Locations locations)
        {
            if (id != locations.Id)
            {
                return NotFound();
